(function() {
	'use strict';
	const MARKDOWN_IT_CDN = '/markdown-it.min.js';
	const HIGHLIGHT_JS_CDN = '/highlight.min.js';
	const HIGHLIGHT_LANG_GO_CDN = '/go.min.js';
	const HIGHLIGHT_LANG_RUST_CDN = '/rust.min.js';
	const HIGHLIGHT_LANG_TS_CDN = '/typescript.min.js';
	const HIGHLIGHT_LANG_PYTHON_CDN = '/python.min.js';
