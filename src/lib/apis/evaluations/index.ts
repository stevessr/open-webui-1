...
export const getConfig = async (token: string = '') => {
	...
	const res = await fetch(`${getWebuiApiBaseUrl()}/evaluations/config`, {
		method: 'GET',
		headers: {
...
export const getAllFeedbacks = async (token: string = '') => {
	...
	const res = await fetch(`${getWebuiApiBaseUrl()}/evaluations/feedbacks/all`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const exportAllFeedbacks = async (token: string = '') => {
	...
	const res = await fetch(`${getWebuiApiBaseUrl()}/evaluations/feedbacks/all/export`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createNewFeedback = async (token: string, feedback: object) => {
	...
	const res = await fetch(`${getWebuiApiBaseUrl()}/evaluations/feedback`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFeedbackById = async (token: string, feedbackId: string) => {
	...
	const res = await fetch(`${getWebuiApiBaseUrl()}/evaluations/feedback/${feedbackId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
