import { getOllamaApiBaseUrl } from '$lib/constants';

export const verifyOllamaConnection = async (token: string = '', connection: dict = {}) => {
	let error = null;

	const res = await fetch(`${getOllamaApiBaseUrl()}/verify`, {
		method: 'POST',
		headers: {
...
export const getOllamaConfig = async (token: string = '') => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/config`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateOllamaConfig = async (token: string = '', config: OllamaConfig) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/config/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOllamaUrls = async (token: string = '') => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/urls`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateOllamaUrls = async (token: string = '', urls: string[]) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/urls/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOllamaVersion = async (token: string, urlIdx?: number) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/version${urlIdx ? `/${urlIdx}` : ''}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOllamaModels = async (token: string = '', urlIdx: null | number = null) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/tags${urlIdx !== null ? `/${urlIdx}` : ''}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generatePrompt = async (token: string = '', model: string, conversation: string) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/generate`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateEmbeddings = async (token: string = '', model: string, text: string) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/embeddings`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateChatCompletion = async (token: string = '', body: object) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/chat`, {
...
export const unloadModel = async (token: string, tagName: string) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/unload`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createModel = async (token: string, payload: object, urlIdx: string | null = null) => {
	...
	const res = await fetch(
		`${getOllamaApiBaseUrl()}/api/create${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const deleteModel = async (token: string, tagName: string, urlIdx: string | null = null) => {
	...
	const res = await fetch(
		`${getOllamaApiBaseUrl()}/api/delete${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'DELETE',
			headers: {
				Accept: 'application/json',
...
export const pullModel = async (token: string, tagName: string, urlIdx: number | null = null) => {
	...
	const res = await fetch(`${getOllamaApiBaseUrl()}/api/pull${urlIdx !== null ? `/${urlIdx}` : ''}`, {
		signal: controller.signal,
		method: 'POST',
		headers: {
			Accept: 'application/json',
...
export const downloadModel = async (
	...
	const res = await fetch(
		`${getOllamaApiBaseUrl()}/models/download${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const uploadModel = async (token: string, file: File, urlIdx: string | null = null) => {
	...
	const res = await fetch(
		`${getOllamaApiBaseUrl()}/models/upload${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'POST',
			headers: {
				Authorization: `Bearer ${token}`
...
// 	return await fetch(`${getOllamaApiBaseUrl()}/pull`, {
// 		method: 'POST',
// 		headers: {
